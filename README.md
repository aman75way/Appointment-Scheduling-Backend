...
erDiagram
    ...
    USER ||--o| APPOINTMENT: "User Appointments"
    USER ||--o| APPOINTMENT: "Staff Appointments"
    USER ||--o| AVAILABILITY_SLOT: "User Availability Slots"
    USER {
        string id
        string email
    }
    ...
    APPOINTMENT ||--o| USER : "User Appointment"
    APPOINTMENT ||--o| USER : "Staff Appointment"
    AVAILABILITY_SLOT ||--o| USER : "User Availability Slot"
```